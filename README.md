...
**Current version: v260806.17** (06.08.2026) - this number always matches the `APP_VERSION` constant near the top of the script in `index.html`. Versioning scheme: `vYYMMDD.zz` (date of the last change + a 2-digit counter that resets to 01 each new day). `cors_test.html`'s own version marker is kept in sync with this.
